        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item active">
                    <a href="{{ route('usertable') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">Users</div>
                    </a>
                </li>
                <li class="menu-item active">
                    <a href="{{ route('newuser') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">New Users</div>
                    </a>
                </li>
                <li class="menu-item active">
                    <a href="{{ route('levellist') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">Level List</div>
                    </a>
                </li>
                <li class="menu-item active">
                ...
                <li class="menu-item active">
                    <a href="{{ route('withdrawrequest') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
