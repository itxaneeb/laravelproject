    ...
    <div class="col-lg-8 mb-4 order-0">
        ...
        <div class="d-flex align-items-end row">
            ...
            <div class="card-body pb-0 px-0 px-md-4">
                <img src="../admin/assets/img/illustrations/man-with-laptop-light.png" height="140" alt="View Badge User" data-app-dark-img="illustrations/man-with-laptop-dark.png" data-app-light-img="illustrations/man-with-laptop-light.html">
            </div>
            </div>
        </div>
        </div>
