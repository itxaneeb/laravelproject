...
@section('content')
    ...
    <div class="row">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
            <form action="{{ route('addprodutss') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="basic-default-name" name="reward" placeholder="Reward" />
                    </div>
                </div>  
